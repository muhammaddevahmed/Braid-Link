...
import { 
  ...
  BadgeCheck, Zap, Layers, Camera, RefreshCw, DollarSign
} from "lucide-react";
...
const AdminCategories = () => {
  ...
  const addHairstyle = (categoryId: string) => {
    ...
    if (hairstyle && hairstyle.name.trim() && hairstyle.image.trim()) {
      ...
      setNewHairstyle({
        ...newHairstyle,
        [categoryId]: { id: "", name: "", description: "", image: "", startingPrice: 0 },
      });
      // Reset file input
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-3 w-full">
            <input
              className="flex-1 px-4 py-3.5 rounded-xl border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent transition-all h-fit"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={addCategory}
              className="bg-accent text-primary text-sm px-6 py-3.5 rounded-xl font-medium flex items-center gap-2 hover:bg-accent/90 transition-all shadow-md h-fit"
            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                  ...
                                  <div className="md:col-span-2 space-y-3">
                                    ...
                                    <div className="relative">
                                      <DollarSign className="w-4 h-4 absolute top-1/2 -translate-y-1/2 left-3 text-muted-foreground" />
                                      <input
                                        type="number"
                                        className="w-full pl-10 pr-3 py-2 rounded-lg border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent transition-all"
                                        placeholder="Starting Price"
                                        value={hairstyle.startingPrice || ""}
                                        onChange={(e) =>
                                          updateHairstyle(category.id, idx, { startingPrice: parseFloat(e.target.value) || 0 })
                                        }
                                      />
                                    </div>
                                    <textarea
                            ...
                            <div className="md:col-span-2 space-y-3">
                              ...
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  placeholder="Starting Price *"
                                  value={newHairstyle[category.id]?.startingPrice || ""}
                                  onChange={(e) =>
                                    setNewHairstyle({
                                      ...newHairstyle,
                                      [category.id]: {
