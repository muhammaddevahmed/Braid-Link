...
import { 
  ...
  BadgeCheck, Zap, Clock, Key, Fingerprint
} from "lucide-react";
    ...
    <div className="relative min-h-screen flex items-center justify-center py-16 px-4 bg-gradient-to-b from-background to-secondary/10">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Access your BraidLink account</p>
        </div>

        {/* Main Login Card - Premium redesign */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            {/* Password Field - Premium redesign */}
            <div className="space-y-2">
              <label className="text-sm font-medium text-primary flex items-center gap-1.5">
                <div className="w-4 h-4 rounded bg-accent/10 flex items-center justify-center">
            ...
            {/* Remember Me & Forgot Password - Premium redesign */}
            <div className="flex items-center justify-between">
              ...
              <button 
                type="button"
                className="text-sm text-accent hover:text-accent/80 font-semibold hover:underline transition-all flex items-center gap-1 group"
              >
            ...
            <motion.button 
              ...
              type="submit" 
              disabled={isLoading}
              className="w-full bg-accent text-primary font-semibold text-sm py-4 rounded-xl flex items-center justify-center gap-2 mt-2 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-accent/90 transition-all duration-300 shadow-lg hover:shadow-accent/25 group"
            >
              {isLoading ? (
                <>
                ...
                <>
                  Sign In <LogIn className="w-4 h-4 group-hover:scale-110 transition-transform" />
                </>
              )}
            </motion.button>
            ...
            <div className="text-center text-sm text-muted-foreground pt-2">
              ...
              <Link to="/signup" className="text-accent font-semibold hover:text-accent/80 inline-flex items-center gap-1 group">
        ...
        {/* Demo Accounts Section - Premium redesign */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-4 text-muted-foreground flex items-center gap-2">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3">
            {[
              ...
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                className={`bg-gradient-to-r ${demo.gradient} rounded-xl p-5 border border-border/50 hover:border-accent/30 transition-all duration-300 hover:shadow-xl group`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      <BadgeCheck className="absolute -top-1 -right-1 w-4 h-4 text-accent bg-card rounded-full" />
                    </div>
                    <div>
                  ...
                  <motion.button
                    ...
                    disabled={isLoading}
                    className="bg-accent text-primary text-xs px-4 py-2.5 rounded-lg flex items-center gap-1.5 whitespace-nowrap hover:bg-accent/90 transition-all duration-300 shadow-md hover:shadow-accent/25 font-semibold"
                  >
                    Quick Login
          ...
          >
            <div className="inline-flex items-center gap-2 text-xs text-muted-foreground bg-card/30 px-3 py-1.5 rounded-full border border-border/30">
              <CheckCircle className="w-3 h-3 text-accent" />
              <span>Use these demo accounts to explore the platform</span>
