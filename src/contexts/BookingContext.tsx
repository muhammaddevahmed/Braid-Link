...
export const BookingProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <BookingContext.Provider value={{ bookings, createBooking, updateBookingStatus, getStylistBookings, getCustomerBookings, getRejectedInstantMatchForCustomer, clearRejectedInstantMatch }}>
      {children}
